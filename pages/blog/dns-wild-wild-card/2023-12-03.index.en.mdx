...
```
/home/rh/artizanya/packages/wui-errors/out/404.html
```
...
```shell
$ cd /home/rh/artizanya/utils/ssl
$ lego --accept-tos \
       --dns=googledomains \
...
```nginxconf
# /home/rh/artizanya/utils/ssl/nginx/sites-available/artizanya.com
...
server {
  ...
  ssl_certificate /home/rh/artizanya/utils/ssl/.lego/certificates/artizanya.com.crt;
  ssl_certificate_key /home/rh/artizanya/utils/ssl/.lego/certificates/artizanya.com.key;
  ssl_trusted_certificate /home/rh/artizanya/utils/ssl/.lego/certificates/artizanya.com.issuer.crt;
  include /home/rh/artizanya/utils/ssl/nginx/letsencrypt/options-ssl-nginx.conf;
  ssl_dhparam /home/rh/artizanya/utils/ssl/nginx/letsencrypt/ssl-dhparams.pem;
...
```shell
$ ln -s /home/rh/artizanya/utils/ssl/nginx/sites-available/artizanya.com /etc/nginx/sites-enabled
```
