...
papers. In my early days in academia my preferred text editor was Microsoft
Word. With some practice and discipline in Word one could achieve
content-presentation separation, consistent automatic styling and a certain
degree of automation, such as images and equations numbering or generating a
table of content. With some additional software and plugins, the level of
automation could be even higher&nbsp;- such as automatic references list or
image placement.
...
my usual then programming text editors were not convenient to edit prose text.
...
some literacy distribution curve. My literacy should be somewhere at another
side of that curve&nbsp;- "innate illiteracy". Thus, after I had Emacs, AUCTeX
...
ispell package with aspell driver. Although ispell was useful, it felt too
manual and retrograde in compare to Word's squiggly lines that I used to.
...
of my insufficient experience with ELisp and lack of interest in getting it
working.

By the time I started working on this site Emacs has became my editor of choice
of all my text editing needs. Even more recent better text editor such as
Sublime and Visual Studio Code do not fit my mindset as well as Emacs. Also, my
ELisp confidence grew together with the size of my emcacs/init.el config file.

From the beginning I wanted my site to have full i18n support and both English
and Russian languages used as a default. Unfortunately, over these years of
practicing Emacs my innate literacy did not become any better and I sill require
a good spellchecker to tell me how I should not write. Initial internet search
revealed a reddit post [Spell checkers in Emacs
in 2020](https://www.reddit.com/r/emacs/comments/fxs92h/spell_checkers_in_emacs_in_2020/)
