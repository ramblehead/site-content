...
<figure>
  <Image
    src="/static/blog/windows-is-not-my-pi/link-local-only.png"
    alt=""
    priority
  />
  <figcaption>
...
<figure>
  <Image
    src="/static/blog/windows-is-not-my-pi/windows-device-manager-com.png"
    alt=""
...
<figure>
  <Image
    src="/static/blog/windows-is-not-my-pi/ubuntu-correct-config.png"
    alt=""
    priority
  />
  <figcaption>
...
<figure>
  <Image
    src="/static/blog/windows-is-not-my-pi/windows-correct-config.png"
    alt=""
    className="!rounded-none"
    priority
  />
