---
title: Как я тут оказалсяч
authors:
  - Виктор Рыбынок
datePublished: '2023-02-01'
dateUpdated: '2023-02-06'
description: Высокоуровневый обзор того как этот сайт начал своё существование
...
<figure>
  ...
  <figcaption>
    <>Front-end Doom</>
    <>[[ref](https://twitter.com/aravindameewal1/status/1362587906661961730)]</>
  </figcaption>
</figure>
...
useful addition in the next project.
...
the content. For that purpose my inclination was to use one the (many) available
static site generators (SSG) and host it on GitHub Pages. Well, the chosen
<abbr title="Static Site Generator">SSG</abbr> software had to be open source,
have a reasonable architecture and use a technology stack that I am already
familiar with or interested to learn in the near feature. Thus, when time comes
I would have more options of extending and improving my site than just relying
on 3rd party mods and plugins.
...
<figure>
  ...
  <figcaption>
    ...
    <>[[ref](https://javascript.plainenglish.io/node-js-esm-npm-yarn-deep-dive-adda15dabce)]</>
  </figcaption>
</figure>
...
contrast to those, Gatsby has a large number of pluggins and themes. Gatsby has
slightly more requirements on the project structure and feels somewhat more
oppinionated - such as internal use of GraphQL to fetch data. Although it is
...
it works and handles monorepositories.
...
[Zendesk Garden](https://garden.zendesk.com/) as an instrument on choice for
...
pop-up or even a button that work consistently from mouse, keyboard and
...
those those libraries are more mature I may revisit my site styling strategy and
...
Unfortunatelly, this solution meas that additionally to plain CSS,
...
<figure>
  ...
  <figcaption>
    <>CSS Anarchy</>
    <>[[ref](https://uxplanet.org/how-it-feels-like-to-style-things-in-2020-54177a93f30d)]</>
  </figcaption>
</figure>
