...
description:
  Высокоуровневый обзор того как этот сайт начал своё существование, а также
  пояснение причин выбора применяемых технических решений, таких как
  используемый фреймворк, библиотеки компонентов, и подходы к стилизации CSS.
