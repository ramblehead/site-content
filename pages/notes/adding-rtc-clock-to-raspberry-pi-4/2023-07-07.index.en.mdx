...
<figure>
  <Image
    src="/static/notes/adding-rtc-clock-to-raspberry-pi-4/modprobe-correct-output.png"
    alt=""
...
If instead of `68` the I2C address is `UU` (Unbound/Unknown) then the I2C
device has been detected but is not bound to the kernel driver.
