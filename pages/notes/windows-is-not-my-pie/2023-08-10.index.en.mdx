...
configuration is little bit more complex, but it works on Ubuntu 22.04 LTS,
Windows 10 and Windows 11 with no additional configuration supporting both RNDIS
and CDC-ECM. To spare myself (and possibly others) from replaying this
