...
no additional configuration, supporting both RNDIS and CDC-ECM USB protocols. To
spare myself (and possibly others) from replaying this configuration in the
future manually, I wrote a few automation
...
The above commands assume that Pi is connected to the Internet to access
GitHub. If it is offline, use some other ways to copy `rpi4-ethernet-over-usb`
repository to your Raspberry Pi home directory.
